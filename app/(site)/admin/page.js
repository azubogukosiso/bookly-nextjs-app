                ...
                <div className="grid w-full grid-cols-1 gap-6 lg:grid-cols-3">
                    <div className='bg-white shadow-lg rounded-lg p-5 border border-slate-300 h-[30vh] flex flex-col justify-between'>
                        ...
                        <div className="flex flex-col lg:flex-row justify-between items-end">
                            <p className="font-medium tracking-wider text-slate-400 mb-3 lg:mb-0">CUSTOMERS</p>
                    ...
                    <div className='bg-white shadow-lg rounded-lg p-5 border border-slate-300 h-[30vh] flex flex-col justify-between'>
                        ...
                        <div className="flex flex-col lg:flex-row justify-between items-end">
                            <p className="font-medium tracking-wider text-slate-400 mb-3 lg:mb-0">ORDERS</p>
                    ...
                    <div className='bg-white shadow-lg rounded-lg p-5 border border-slate-300 h-[30vh] flex flex-col justify-between'>
                        ...
                        <div className="flex flex-col lg:flex-row justify-between items-end">
                            <p className="font-medium tracking-wider text-slate-400 mb-3 lg:mb-0">BOOKS</p>
