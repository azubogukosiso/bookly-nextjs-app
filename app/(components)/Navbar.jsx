...
const Navbar = ({ session }) => {
    ...
    async function handleSessionEdit() {
        ...
        console.log("Here it is: ", updateSession);
    }
                ...
                <div className="gap-4 navbar-end">
                    {
                        ...
                        <>
                            <button className="bg-blue-700 rounded-full p-3 indicator" onClick={() => document.getElementById('cartModal').showModal()}>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="w-5 h-5"
                                    fill="none"
                            ...
                            <dialog id="cartModal" className="modal text-black">
                                <div className="modal-box w-11/12 max-w-5xl">
                                    <h3 className="font-bold text-lg mb-3">{cartHeader}</h3>
                                        ...
                                        booksInCart.map((book, index) => (
                                            <div className={`relative flex flex-col justify-between ${booksInCart.length - 1 !== index && "mb-5"} md:flex-row bg-slate-200 p-5 rounded-lg block`} key={book._id}>
                                                ...
                                                <div className="flex w-full md:w-[30%] items-center justify-evenly mt-5">
                                                    <button className="btn text-white transition-all bg-blue-600 active:scale-90" onClick={() => dispatch({ type: 'DECREASE_QTY', payload: book })}>-</button>
                                                    {book.qty}
                                                    <button className="btn text-white transition-all bg-blue-600 active:scale-90" onClick={() => dispatch({ type: 'INCREASE_QTY', payload: book })}>+</button>
                                                </div>
                                            </div>
                                        ))
                                    }
                    ...
                    {/* ################## USER PROFILE ################## */}
                    <>
                        <button className="bg-blue-700 rounded-full p-3" onClick={() => document.getElementById('profileModal').showModal()}>
                        ...
                        <dialog id="profileModal" className="modal text-black">
                            <div className="modal-box w-11/12 max-w-5xl">
