...
import { removeFromCart } from "@/app/(functions)/removeFromCart";
...
const Navbar = ({ session }) => {
    ...
    return (
        <div className="navbar rounded-md bg-blue-600 text-white z-50 font-[family-name:var(--font-inter)]">
                    ...
                    <div className="gap-2 navbar-end">
                            ...
                            <div className="dropdown dropdown-end">
                                <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
                                    <div className="indicator">
                                        ...
                                        <span className="badge badge-sm indicator-item">{booksInCart && booksInCart.length}</span>
                                    </div>
                                </div>
                                ...
                                <div
                                    ref={bookCartRef}
                                    tabIndex={0}
                                    className="card card-compact dropdown-content bg-base-100 z-[1] mt-3 w-[350px] md:w-[500px] max-h-[450px] shadow-lg">
                                    <div className="overflow-y-auto text-black card-body">
                                        ...
                                        <div className="overflow-y-scroll">
                                            {
                                                booksInCart.map(book => (
                                                    <div className="relative flex flex-col justify-between h-20 mb-32 md:flex-row md:mb-10" key={book._id}>
                                                        <div className="w-full md:w-[70%] flex">
                                                            <div className="relative w-[50%] md:w-[30%] p-1 overflow-hidden border-2 border-gray-300 rounded-xl">
                                                            ...
                                                            <div className="flex flex-col items-start w-[50%] justify-center ps-2">
                                                                ...
                                                                <button className="px-2 py-1 text-white transition-all bg-red-600 rounded-lg active:scale-90" onClick={() => removeFromCart(book, bookCartRef, dispatch)}>
                                                                    Remove
                                                                </button>
                                                            </div>
                                                        </div>
                                                        <div className="flex w-full md:w-[30%] items-center justify-evenly mt-5">
                                                            <button className="px-4 py-2 text-white transition-all bg-blue-600 rounded-lg active:scale-90" onClick={() => dispatch({ type: 'DECREASE_QTY', payload: book })}>-</button>
                                                            {book.qty}
                                                            <button className="px-4 py-2 text-white transition-all bg-blue-600 rounded-lg active:scale-90" onClick={() => dispatch({ type: 'INCREASE_QTY', payload: book })}>+</button>
                                                        </div>
                                                    </div>
                                                ))
                                            }
                        ...
                        <div className="dropdown dropdown-end">
                            ...
                            <div
                                ref={userProfileRef}
                                tabIndex={0}
                                className="card card-compact dropdown-content bg-base-100 z-[1] mt-3 w-[350px] md:w-[500px] max-h-[450px] shadow-lg text-black">
                                <div className="overflow-y-auto text-black card-body">
                                    <h4>User Profile</h4>

                                    {
                                        session.user.isGoogleAccount ? <div>
                                            ...
                                            <form className="mt-4" onSubmit={(e) => changeUserDetails(e, firstName, "firstName", session.user.id, setIsLoadingFirstName, userProfileRef, handleSessionEdit)}>
...

                                    {
                                        session.user.isGoogleAccount ? <div className="mt-3">
                                            ...
                                            <form className="mt-4" onSubmit={(e) => changeUserDetails(e, lastName, "lastName", session.user.id, setIsLoadingLastName, userProfileRef, handleSessionEdit)}>
...

                                    {
                                        session.user.isGoogleAccount ? <div className="mt-3">
                                            ...
                                            <form className="mt-4" onSubmit={(e) => changeUserDetails(e, email, "email", session.user.id, setIsLoadingEmail, userProfileRef, handleSessionEdit)}>
...

                                    {
                                        session.user.isGoogleAccount ? <div className="mt-3">
                                            ...
                                            <form className="mt-4" onSubmit={(e) => changeUserDetails(e, shippingAddress, "shippingAddress", session.user.id, setIsLoadingShippingAddress, userProfileRef, handleSessionEdit)}>
...

                                    {
                                        ...
                                        <form className="mt-4" onSubmit={(e) => changeUserDetails(e, { oldPassword, newPassword }, "password", session.user.id, setIsLoadingPassword, userProfileRef, handleSessionEdit)}>
