    ...
    return (
        <footer className="p-10 rounded-md bg-blue-600 font-[family-name:var(--font-inter)] text-white">
            ...
            <div className="flex justify-center items-center p-3 mt-10 bg-blue-700 border-l-4 border-white rounded-md font-[family-name:var(--font-inter)] text-sm text-white">
                ...
                <div className="flex">
                    {/* ########## LINKEDIN ICON ########## */}
                    <a href="https://www.linkedin.com/in/azubogu-kosisochukwu" className="mr-3">
                    ...
                    {/* ########## GITHUB ICON ########## */}
                    <a href="https://www.github.com/azubogukosiso" className="mr-3">
                    ...
                    {/* ########## X ICON ########## */}
                    <a href="https://www.x.com/azuboguko">
