                        ...
                        <div className="flex items-center justify-end">
...

                            {
                                ...
                                <>
                                    ...
                                    {
                                        isFavourite ?
                                            <button className={`p-4 ml-2 text-white transition-all bg-blue-600 rounded-lg active:scale-90 tooltip tooltip-left ${isLoadingRemoveFromFavourites && "opacity-75 cursor-not-allowed"}`} data-tip="Remove from Favourites" onClick={() => removeFromFavourites(bookDetails, session.user.id, setIsLoadingRemoveFromFavourites)} disabled={isLoadingRemoveFromFavourites}>
                                                {
                                                    isLoadingRemoveFromFavourites ?
                                            ...
                                            :
                                            <button className={`p-4 ml-2 text-white transition-all bg-blue-600 rounded-lg active:scale-90 tooltip tooltip-left ${isLoadingAddToFavourites && "opacity-75 cursor-not-allowed"}`} data-tip="Add to Favourites" onClick={() => addToFavourites(bookDetails, session.user.id, setIsLoadingAddToFavourites)} disabled={isLoadingAddToFavourites}>
                                                {
