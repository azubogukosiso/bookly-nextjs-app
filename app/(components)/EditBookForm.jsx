...
const EditBookForm = ({ book }) => {
  ...
  const editBook = async (e) => {
    ...
    try {
      ...
      if (json) toast.success(json.message, { duration: 5000, style: { background: '#2563eb', color: '#fff', padding: '20px' }, className: "font-[family-name:var(--font-inter)]" });
  ...
  return (
    <div className="mb-10">
      ...
      <form onSubmit={editBook}>
        ...
        <button type="submit" className={`rounded-lg w-full p-3 text-white transition-all bg-blue-600 active:scale-90 ${isLoadingEditBook && "opacity-75 cursor-not-allowed"}`} disabled={isLoadingEditBook}>{isLoadingEditBook ?
