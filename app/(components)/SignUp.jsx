    ...
    return (
        <div className="flex flex-col lg:flex-row my-20 min-h-[70vh]">
            ...
            <form className="flex flex-col justify-center w-full mt-10 lg:ml-10 lg:mt-0 lg:w-3/5" onSubmit={signUpCustomer}>
                ...
                <button type="submit" className={`p-3 rounded-lg mt-10 text-white bg-blue-600 ${isLoading && "opacity-75 cursor-not-allowed"}`} disabled={isLoading}>{isLoading ? <span className='flex items-center justify-center text-center'>
