...
const SignUp = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row my-20 min-h-[70vh]">
            <div className="bg-blue-600 rounded-lg w-full lg:w-1/3 text-white p-10 flex flex-col justify-between">
            ...
            <form className="lg:ml-10 mt-10 lg:mt-0 flex flex-col justify-center w-full lg:w-3/5" onSubmit={signUpCustomer}>
                ...
                <button type="submit" className="btn bg-blue-600 text-white mt-10" disabled={isLoading}>{isLoading ? "Creating your account..." : "Create Account"}</button>
            </form>
        </div>
    )
}
