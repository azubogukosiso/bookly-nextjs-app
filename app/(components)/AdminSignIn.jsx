    ...
    return (
        <div className="flex flex-col lg:flex-row my-20 min-h-[70vh]">
            <div className="flex flex-col justify-between w-full p-10 text-white bg-blue-600 rounded-lg lg:w-1/3">
                <h1 className="mb-5 lg:mb-0">Admin - for Admins</h1>
            ...
            <form className="flex flex-col justify-center w-full mt-10 lg:ml-10 lg:mt-0 lg:w-3/5" onSubmit={(e) => signInUser(e, { data, setEmailErrMsg, setPasswordErrMsg, setIsLoading })}>
                ...
                <button type="submit" className={`mt-10 text-white bg-blue-600 rounded-lg p-3 ${isLoading && "cursor-not-allowed opacity-75"}`} disabled={isLoading}>{isLoading ? <span className='flex items-center justify-center text-center'>
